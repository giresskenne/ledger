...
export default function AddAssetScreen() {
  ...
  const handleSubmit = () => {
    ...
    const finalPurchasePrice = startTrackingToday ? parseFloat(currentPrice) : parseFloat(purchasePrice);
    ...
    <View className="flex-1 bg-[#0A0A0F]">
      ...
      >
        ...
        >
          ...
          <Text className="text-white text-lg font-semibold">Add Asset</Text>
          <Pressable
        ...
        >
          ...
          <Animated.View entering={FadeInDown.delay(250)} className="mt-6 flex-row gap-4">
            ...
            <View className="flex-1">
              ...
              <TextInput
                ...
                placeholder="0.00"
                placeholderTextColor="#6B7280"
                className={cn("bg-white/10 rounded-xl p-4 text-white", startTrackingToday && "opacity-50")}
                keyboardType="decimal-pad"
          ...
          <Animated.View entering={FadeInDown.delay(400)} className="mt-6">
            ...
            >
              <Text className={cn("text-white", startTrackingToday && "text-gray-500")}>
              ...
              <Calendar size={20} color={startTrackingToday ? "#4B5563" : "#9CA3AF"} />
            </Pressable>
          ...
          {canSearchTicker && (
            <Animated.View entering={FadeInDown.delay(425)} className="mt-4">
              <Pressable
                ...
                className="bg-white/5 rounded-xl p-4 flex-row items-center justify-between"
              >
                <View className="flex-1 mr-3">
                  <Text className="text-white text-sm font-medium">Start tracking from today</Text>
